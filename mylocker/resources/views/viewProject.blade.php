...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="ibox ">
                <div class="ibox-title">
                    <h2 class="font-bold m-b-xs">Responsáveis associados</h2>
                </div>

                <div class="ibox-content" >
                    <a id="addTeacherOpen" class="btn btn-outline btn-info m-xs" data-toggle="modal" data-target="#addTeacher">Adicionar Responsável  <i class="fa fa-plus"> </i></a>
            ...
            <div class="modal-content animated bounceInRight">
                ...
                <form method="POST" action="{{route('addprojectteacher',$project->id)}}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="lg-sm-2">
                            <div class="form-group">
                                <label class="col-form-label" for="Docentes">Responsáveis Disponíveis</label>
