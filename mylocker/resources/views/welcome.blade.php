                ...
                <div class="ibox ">
                    <div class="ibox-content product-box">
                        <div class="product-desc">
                            ...
                            <p class="product-name"><i class="fa fa-address-card"></i> Gerir Responsáveis</p>
                            <div>
                                Gerir os Responsáveis
                            </div>
                            <div class="m-t text-righ">
                                <a href="{{ route('managemanagers') }}" class="btn btn-xs btn-outline btn-primary">Ir para
                                    <i class="fa fa-long-arrow-right"></i> </a>
                            </div>
                        </div>
                    </div>
