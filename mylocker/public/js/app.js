...
$(document).ready(function () {
    ...
    $('.navbar-minimalize').on('click', function (event) {
        ...
        if($("#header").hasClass("fixed-header")){
            $("#header").addClass("fixed-header-mini");
            $("#header").removeClass("fixed-header");
        }else{
            $("#header").removeClass("fixed-header-mini");
            $("#header").addClass("fixed-header");
        }   

        if (window.innerWidth  < 769) {
            $(".navbar-default").toggleClass("mini-sidebar");
        }
...
$(window).bind("resize", function () {
    if (window.innerWidth  < 769) {
        ...
        $(".navbar-default").removeClass("mini-sidebar");
        if($("#header").hasClass("fixed-header")){
            $("#header").addClass("fixed-header-mini").animate();
            SmoothlyMenu();
            $("#header").removeClass("fixed-header");
        }else{
            $("#header").removeClass("fixed-header-mini");
            $("#header").addClass("fixed-header").animate();
            SmoothlyMenu();
        }
    } else {
        $('body').removeClass('body-small')
