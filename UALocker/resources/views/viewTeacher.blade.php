...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('manageteachers')}}">Gerir contas </a>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group row ">
                        ...
                        <a id="dropTeacher" href="{{route('dropteacher',$teacher->id)}}" class="btn btn-outline btn-danger m-xs">Apagar <i class="fa fa-times"></i> </a>
                    </div>
