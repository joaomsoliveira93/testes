...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <a href="" class="btn btn-success btn-rounded floatButton" data-toggle="modal" data-target="#addTeacher"> <span class="fa fa-plus"></span> Novo Docente</a>
...
<div class="wrapper wrapper-content animated fadeInRight ecommerce" >
    ...
    <div class="ibox-content m-b-sm border-bottom" >
        <form type="get" action="{{url('/teachers/search')}}">
            <div class="row">
                <div class="col-sm-2">
                        ...
                        <tbody>
                            ...
                            <tr class="footable-even">
                                ...
                                <td class="text-right footable-visible footable-last-column">
                                    <div class="btn-group">
                                        <a href="{{route('viewteacher', $teacher->id)}}" class="btn btn-xs btn-outline btn-primary">Detalhes </a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Adicionar um docente</h4>
                </div>
                ...
                <form method="POST" action="{{route('addteacher')}}">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Adicionar docente</button>
                    </div>
