                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element ">
                            <h1 class="font-bold m-l-xl" style="color:white">My &nbsp;<i class="fa fa-lock" ></i></h1>
                        </div>
                        <div class="logo-element">
                            <ul class="nav metismenu">
                                <li class="nav-item">
                                    My &nbsp;<i class="fa fa-lock"></i>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="treeview {{ ($prefix == 'manager')?'active':'' }}">
                        <a href="{{route('managemanagers')}}" title="Manage Teachers"><i class="fa fa-address-card"></i> <span class="nav-label">Gerir Responsáveis</span></a>
                    </li>
