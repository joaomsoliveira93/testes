...
export const Sidebar = () => {
  ...
  return (
    <div className="fixed top-[48px] sidebar w-72 dark:bg-[#484B52] shadow-xl z-40 shadow-black bg-slate-200  bottom-0 md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10">
        <ToggleSidebar />    
